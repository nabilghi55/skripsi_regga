...
<head>
    ...
    <title>Laporan Jadwal Khotbah Jumat - SIKJ CMM</title>
...
<body>
    ...
    <div class="report-header">
        ...
        <h2>Laporan Jadwal Khotbah Jumat</h2>
    ...
    <div class="report-meta">
        <div>
            ...
            @else
                <strong>Kategori:</strong> Semua Jadwal
            @endif
        </div>
        <div>
    ...
    <table class="report-table">
        ...
        <tbody>
            @forelse($jadwals as $index => $j)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td style="font-weight: 600;">{{ $j->tanggal->translatedFormat('l, d F Y') }}</td>
                    <td style="font-weight: 700;">{{ $j->masjid->nama }}</td>
                    <td>{{ $j->masjid->kecamatan }}</td>
