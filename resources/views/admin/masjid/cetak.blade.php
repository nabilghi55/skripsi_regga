...
<head>
    ...
    <title>Laporan Data Masjid - SIKJ CMM</title>
...
<body>
    ...
    <div class="report-header">
        ...
        <h2>Laporan Data Masjid SIKJ</h2>
    ...
    <div class="report-meta">
        <div>
            ...
            @else
                <strong>Kecamatan:</strong> Semua Kecamatan di Malang
            @endif
            @if($search)
    ...
    <table class="report-table">
        ...
        <tbody>
            @forelse($masjids as $index => $m)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td style="font-weight: 700;">{{ $m->kode_masjid ?? '-' }}</td>
    ...
    <div class="print-actions no-print">
        <a href="{{ route('admin.masjid.index') }}" class="btn btn-back">
            Kembali
        </a>
